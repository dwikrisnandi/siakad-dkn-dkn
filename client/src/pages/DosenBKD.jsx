		...
		<div className="animate-fade-in">
			<div className="d-flex justify-content-between align-items-center mb-4">
				<h3 className="fw-bold text-dark mb-0">
					<FileText size={28} className="me-2 text-primary" /> Repository BKD &
					SISTER
				</h3>
				<button
			...
			<div className="alert alert-info rounded-4 border-0 shadow-sm p-4 mb-4">
				...
				<p className="mb-0">
					Simpan seluruh bukti kinerja Pendidikan, Penelitian, dan Pengabdian
					Anda di sini. Gunakan tombol <strong>Salin Link</strong> untuk
					mendapatkan URL publik (tanpa password) yang dapat langsung di-
					<em>paste</em> ke dalam isian web <strong>SISTER Kemdikbud</strong>.
				</p>
			</div>
			...
			{showForm && (
				<div className="card shadow-sm border-0 rounded-4 mb-4 animate-fade-in">
					<div className="card-header bg-white border-bottom p-4">
						<h6 className="fw-bold mb-0">Upload Dokumen Baru</h6>
					</div>
					<div className="card-body p-4">
						<form onSubmit={handleUpload}>
							<div className="row g-3">
								...
								<div className="col-md-5">
									...
									<input
										...
										placeholder="Misal: SK Mengajar Sem Ganjil 2026"
										value={title}
							...
							<div className="text-end mt-4">
								<button
									type="button"
									className="btn btn-light rounded-pill me-2 px-4"
								...
								<tr key={d.id}>
									...
									<td className="pe-4 text-end">
										...
										>
											...
											<span className="ms-1">
												{copiedId === d.id ? "Tersalin!" : "Copy Link"}
											</span>
										</button>
										<a
											href={d.file_url}
											target="_blank"
											rel="noreferrer"
											className="btn btn-sm btn-light text-primary rounded-pill me-2"
										>
											Lihat
										</a>
										<button
