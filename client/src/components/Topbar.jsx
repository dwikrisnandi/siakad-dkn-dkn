import { Bell, FileText, KeyRound, LogOut, Menu } from "lucide-react";
	...
	const handleNotifClick = (e, notif) => {
		...
		if (user.role === "mahasiswa") {
			navigate("/mahasiswa/assignments", {
				state: { schedule_id: notif?.schedule_id, assignment_id: notif?.id },
			});
		...
		<nav className="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul className="navbar-nav ms-auto d-flex align-items-center">
					...
					<li className="nav-item dropdown me-3">
						...
						>
							...
							{notifications.count > 0 && (
								<span
									className="badge bg-danger navbar-badge"
						...
						>
											...
											<div className="d-flex align-items-start gap-2">
												...
												<div>
													...
													<p className="mb-0 text-muted small">
														{user.role === "mahasiswa"
															? `Tugas: ${n.title} (Belum kumpul)`
															: `${n.mahasiswa_name} mengumpulkan ${n.title}`}
													</p>
													{user.role === "dosen" && (
														<small
							...
							<a
								href="#"
								className="dropdown-item dropdown-footer text-center"
								onClick={(e) => handleNotifClick(e, null)}
							>
								Lihat Semua Tugas
							</a>
						</div>
				...
				<li className="nav-item dropdown me-2">
					...
					>
						<div
							className="d-flex flex-column text-end d-none d-md-flex me-2"
						...
						<div
							className="bg-primary text-white d-flex align-items-center justify-content-center rounded-circle fw-bold"
					...
					>
						...
						<a
							href="#"
							className="dropdown-item text-dark d-flex align-items-center py-2"
							onClick={(e) => {
								e.preventDefault();
						...
						>
							<KeyRound size={16} className="me-2 text-primary" /> Ganti
							Password
						</a>
						<div className="dropdown-divider"></div>
						<a
