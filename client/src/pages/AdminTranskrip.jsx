import { GraduationCap, Loader, Printer, Search } from "lucide-react";
			...
			<div className="animate-fade-in">
				...
				{loading ? (
					<div className="text-center py-5">
						<Loader className="spin" size={32} /> Memuat Transkrip...
					</div>
				) : !data ? (
								...
								<tfoot className="fw-bold bg-light">
									<tr>
										...
										<td className="text-center">
											{data.items
												.reduce(
													(acc, curr) => acc + parseFloat(curr.total_mutu),
													0,
												)
												.toFixed(2)}
										</td>
	...
	return (
		<div className="animate-fade-in">
			<h3 className="fw-bold mb-4 text-dark">
				<GraduationCap size={28} className="me-2 text-primary" /> Cetak
				Transkrip Mahasiswa
			</h3>
